...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="fname" placeholder="Part Name" required="true"></div>
				<div class="col"><input type="text" class="form-control" name="lname" placeholder="Part Description" required="true"></div>
			</div>        	
        </div>
        <div class="form-group">
