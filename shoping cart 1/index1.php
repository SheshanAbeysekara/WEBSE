<?php
    session_start();
    $db_name = "phpcrud";
    $connection = mysqli_connect("localhost","root","","$db_name","3308");
        ...
        <div class="table-responsive">
            ...
            <?php
                ...
                <tr>
                        ...
                        <td><a href="index1.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span class="text-danger">Remove Item</span></a></td>
                </tr>
                <?php
